...
export const CategoryCard: React.FC<CategoryCardProps> = ({ title, description, image, slug }) => {
  ...
  return (
    <div style={{ perspective: 1000, height: '100%' }}>
      <Link 
        ...
        title={`Explore premium ${title} collections`}
      >
        <div
          ref={cardRef}
        ...
        >
          ...
          <div className="product-img-wrapper" style={{ overflow: 'hidden', aspectRatio: '4/3' }}>
            <img 
              ref={imgRef}
              src={image} 
              alt={`Premium ${title} catalog by Urban Frill`} 
